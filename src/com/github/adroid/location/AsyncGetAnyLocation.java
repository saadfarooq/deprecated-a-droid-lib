...
public class AsyncGetAnyLocation extends AsyncTask<Void, Void, Object> implements LocationListener {
	...
	public AsyncGetAnyLocation(AsyncCaller caller) {
		this.caller = caller;
	}
	
	public AsyncGetAnyLocation(AsyncCaller caller, int requestCode) {
		this.caller = caller;
